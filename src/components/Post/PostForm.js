import { Box, Button, Input, Textarea, FormControl, FormLabel, Select, VStack, HStack, Avatar, Text } from "@chakra-ui/react";
      ...
      <VStack spacing={4} align="stretch">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <FormControl id="content" mb={4}>
            <FormLabel fontWeight="bold">Share something with the community</FormLabel>
            <Textarea
              value={content}
